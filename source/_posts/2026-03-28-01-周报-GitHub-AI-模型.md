...
这周 GitHub 上的 Agent 框架项目爆发式增长，Trending 榜单有一半是 Agent 工具类。但不能只看热闹——这背后有三条明确的技术分化方向在同时推进：工具层的完善、方法论层的积累、以及记忆层的突破。同时 Agent 安全协议方向出现了值得关注的新进展。
...
everything-claude-code 这周 Star 增速极快。它不是某个具体工具，而是一套经过 10 个月真实产品开发打磨出来的 Agent Harness 性能优化系统。它的定位是"让 Claude Code、Cursor、Codex、OpenCode 这些 Harness 从能用变成好用"。
...
- **Skills 系统**：跨会话自动识别重复模式，转化为可复用技能。Agent 完成一个任务后，这个任务的处理方式可以被固化下来，下次遇到类似任务自动调用，不需要重新设计
...
Nous Research 出品的自改进 Agent，本周继续保持增长势头。它的核心差异化在于内置了学习闭环——Agent 不是被动响应指令，而是主动积累经验并改进自己。
...
| 项目 | 链接 | 本周 stars | 总 stars |
|---|---|---|---|
| everything-claude-code | https://github.com/affaan-m/everything-claude-code | ~22,000 | ~113,000 |
| superpowers | https://github.com/obra/superpowers | ~17,000 | ~119,000 |
| deer-flow | https://github.com/bytedance/deer-flow | ~17,000 | ~50,000 |
| TradingAgents | https://github.com/TauricResearch/TradingAgents | ~9,200 | ~43,000 |
| TradingAgents-CN | https://github.com/hsliuping/TradingAgents-CN | ~2,900 | ~21,800 |
| hermes-agent | https://github.com/NousResearch/hermes-agent | ~4,900 | ~14,800 |
| project-nomad | https://github.com/Crosstalk-Solutions/project-nomad | ~14,500 | ~18,400 |
| MoneyPrinterV2 | https://github.com/FujiwaraChoki/MoneyPrinterV2 | ~10,100 | ~26,800 |
| last30days-skill | https://github.com/mvanhorn/last30days-skill | ~7,300 | ~13,100 |
| claude-hud | https://github.com/jarrodwatts/claude-hud | ~5,000 | ~14,400 |
| opendataloader-pdf | https://github.com/opendataloader-project/opendataloader-pdf | ~3,200 | ~9,900 |
