...
description: "读文献时最怕的不是方法看不懂，而是图看不懂。火山图为什么长两个翅膀，GSEA 那座小山包是什么，KM 曲线上的小加号又是谁——每张图都在用坐标轴和颜色讲一个统计故事，讲不通就会被审稿人抓住。"
publishDate: 2026-09-12 08:00:00
tags: ["图表大全", "科研绘图", "生信入门", "蛋白质"]
---
...
![火山图](/old/img/bio-plots/01-volcano.png)
...
<details>
<summary>展开查看：这组模拟数据（CSV，与图中完全一致）</summary>
...
<details>
<summary>展开查看：完整绘图代码（Python matplotlib）</summary>
...
![表达热图](/old/img/bio-plots/02-heatmap.png)
...
![相关性热图](/old/img/bio-plots/03-corr-heatmap.png)
...
<details>
<summary>展开查看：模拟数据（CSV，下三角与图一致）</summary>
...
![Pearson 散点](/old/img/bio-plots/04-pearson.png)
...
![Pearson 与 Spearman 对比](/old/img/bio-plots/05-spearman.png)
...
![箱线图](/old/img/bio-plots/06-boxplot.png)
...
<details>
<summary>展开查看：模拟数据（CSV，与 2.7 小提琴图共用同一组）</summary>
...
![小提琴图](/old/img/bio-plots/07-violin.png)
...
<details>
<summary>展开查看：绘图代码（Python，独立可运行）</summary>
...
![三处理韦恩图](/old/img/bio-plots/08-venn-treatment.png)
...
<details>
<summary>展开查看：模拟数据（各区间基因数）</summary>
...
![物种间韦恩图](/old/img/bio-plots/09-venn-ortholog.png)
...
![UpSet 图](/old/img/bio-plots/10-upset.png)
...
<details>
<summary>展开查看：模拟数据（交集成员矩阵与大小）</summary>
...
![TPM 分布](/old/img/bio-plots/11-tpm-dist.png)
...
<details>
<summary>展开查看：模拟数据与绘图代码</summary>
...
![PCA 得分图](/old/img/bio-plots/12-pca.png)
...
<details>
<summary>展开查看：模拟数据（样本得分 CSV）</summary>
...
![UMAP 图](/old/img/bio-plots/13-umap.png)
...
<details>
<summary>展开查看：模拟数据（细胞坐标 CSV）</summary>
...
![聚类树热图](/old/img/bio-plots/14-dendro-heatmap.png)
...
<details>
<summary>展开查看：绘图代码（Python，独立可运行，数据复用 2.2 节）</summary>
...
![KEGG 气泡图](/old/img/bio-plots/16-kegg-bubble.png)
...
![KEGG 柱形图](/old/img/bio-plots/17-kegg-bar.png)
...
![GO 弦图](/old/img/bio-plots/15-go-chord.png)
...
<details>
<summary>展开查看：模拟数据（基因-功能关联表）</summary>
...
![GSEA](/old/img/bio-plots/18-gsea.png)
...
<details>
<summary>展开查看：模拟数据（排序基因表）</summary>
...
![ROC 曲线](/old/img/bio-plots/19-roc.png)
...
<details>
<summary>展开查看：模拟数据（标签与三模型打分）</summary>
...
![生存曲线](/old/img/bio-plots/20-km.png)
...
<details>
<summary>展开查看：模拟数据（时间-事件表）</summary>
...
![DCA 决策曲线](/old/img/bio-plots/21-dca.png)
...
<details>
<summary>展开查看：模拟数据（净收益表）</summary>
...
![森林图](/old/img/bio-plots/22-forest.png)
...
<details>
<summary>展开查看：模拟数据（研究效应量表）</summary>
...
![qRT-PCR 柱状图](/old/img/bio-plots/23-qrt-pcr-bar.png)
...
<details>
<summary>展开查看：模拟数据（原始 Ct 值，图中柱高由它算出）</summary>
...
![扩增曲线](/old/img/bio-plots/24-amp-curve.png)
...
<details>
<summary>展开查看：模拟数据（循环-荧光表）</summary>
...
![熔解曲线与导数峰](/old/img/bio-plots/25-melt-curve.png)
...
<details>
<summary>展开查看：模拟数据（温度-荧光表）</summary>
...
![扩增子 CDS 锚定图](/old/img/bio-plots/26-amplicon-cds.png)
...
<details>
<summary>展开查看：模拟数据（基因结构坐标表）</summary>
...
![Co-IP 示意图](/old/img/bio-plots/27-wb-coip.png)
...
<details>
<summary>展开查看：绘图代码（Python，示意条带，非真实膜图）</summary>
...
![免疫组化示意](/old/img/bio-plots/28-ihc.png)
...
<details>
<summary>展开查看：模拟统计（阳性细胞计数）</summary>
...
![免疫荧光示意](/old/img/bio-plots/29-if.png)
...
<details>
<summary>展开查看：模拟统计（各通道信号计数）</summary>
...
![TUNEL 示意](/old/img/bio-plots/30-tunel.png)
...
<details>
<summary>展开查看：模拟统计（阳性核计数）</summary>
...
![流式细胞周期](/old/img/bio-plots/31-flow-cycle.png)
...
<details>
<summary>展开查看：模拟数据（分箱计数表）</summary>
...
![流式表型门控](/old/img/bio-plots/32-flow-pheno.png)
...
<details>
<summary>展开查看：模拟数据（细胞散点表）</summary>
...
![流式凋亡](/old/img/bio-plots/33-flow-apop.png)
...
![桑基图](/old/img/bio-plots/34-sankey.png)
...
![蛋白结构锚点与 pLDDT](/old/img/bio-plots/35-protein-anchor.png)
...
<details>
<summary>展开查看：模拟数据（逐残基 pLDDT 与锚点表）</summary>
...
![证据矩阵](/old/img/bio-plots/36-evidence-matrix.png)
...
<details>
<summary>展开查看：模拟数据（证据矩阵 0/1 表）</summary>
...
![组织表达](/old/img/bio-plots/37-tissue-expression.png)
...
<details>
<summary>展开查看：模拟数据（组织表达表）</summary>
...
![启动子顺式元件](/old/img/bio-plots/38-promoter-cis.png)
...
<details>
<summary>展开查看：模拟数据（元件坐标表）</summary>
...
![BRGA 通路动态](/old/img/bio-plots/39-brga-dynamics.png)
...
<details>
<summary>展开查看：模拟数据（时期表达表）</summary>
...
![级联热图](/old/img/bio-plots/40-cascade-heatmap.png)
...
<details>
<summary>展开查看：模拟数据（时间进程 z-score 表）</summary>
...
![脊线图](/old/img/bio-plots/41-ridgeline.png)
...
<details>
<summary>展开查看：模拟数据（各簇表达值）</summary>
...
本文全部图片由 Python 3.14 + matplotlib 3.11 在 WSL 里渲染，绘图脚本和这 38 组模拟数据都在仓库 `tools/bio-plots/` 目录下，想复现哪张就翻哪个 `ch*.py`。清单没有断在这里：[第二篇](/2026/09/12/2026-09-12-02-bio-plots-02-population-single-cell/)把 Circos 圈图、共线性点阵、系统发育树这些群体遗传与比较基因组的图收了，[第三篇](/2026/09/12/2026-09-12-03-bio-plots-03-qc-to-spatial-omics/)和[第四篇](/2026/09/12/2026-09-12-04-bio-plots-04-ppi-to-multiomics/)还有 Sanger 峰图、LocusZoom、Hi-C、空间转录组和 AI 多组学，四篇合计 133 张。
...
- 工具链架构细节见拆解文：[拆 Bio SDK：一个"不生成脚本"的本地生信工具链是怎么搭的](/old//2026/08/19/2026-08-19-05-拆Bio-SDK-一个不生成脚本的本地生信工具链是怎么搭的/)。


---

> **原文存档**：本文初版发布于旧站（Butterfly 主题）。如遇图表、代码高亮或 3D 交互显示异常，请查阅 [完整存档版](/old/2026/09/12/2026-09-12-01-生信图表大全第一篇-41张图的坐标轴参数与绘制语言)。
