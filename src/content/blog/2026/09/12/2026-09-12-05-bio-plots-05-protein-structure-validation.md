...
description: "第四篇收在 AI 多组学，但「结构 → 变异 → 表达」这条主线还欠一整篇：拿到一个点突变，怎么把它标到三维结构上？口袋是松了还是紧了？预测完之后，qPCR 和半定量 RT-PCR 怎么把结论落成柱状图和凝胶？这篇 …"
publishDate: 2026-09-12 12:00:00
tags: ["图表大全", "科研绘图", "蛋白质", "蛋白质结构"]
---
...
<details>
<summary>展开查看：PDB 解析与绘图代码</summary>
...
<details>
<summary>展开查看：口袋残基距离表与绘图代码</summary>
...
<details>
<summary>展开查看：两个视图的嵌入配置</summary>
...
<details>
<summary>展开查看：pLDDT 渐变着色配置</summary>
...
<details>
<summary>展开查看：链选择与融合标签剔除配置</summary>
...
![PAE 热图](/old/img/bio-plots/143-pae-map.png)
...
<details>
<summary>展开查看：PAE 数据（节选）与绘图代码</summary>
...
![结构叠合](/old/img/bio-plots/145-superpose.png)
...
<details>
<summary>展开查看：逐残基偏差表与 Kabsch 叠合代码</summary>
...
![棒棒糖图](/old/img/bio-plots/146-mutation-lollipop.png)
...
<details>
<summary>展开查看：突变得分表与绘图代码</summary>
...
![替换矩阵](/old/img/bio-plots/147-substitution-matrix.png)
...
<details>
<summary>展开查看：替换矩阵数据与绘图代码</summary>
...
![ΔΔG 条形图](/old/img/bio-plots/148-ddg-bars.png)
...
<details>
<summary>展开查看：ΔΔG 数据与绘图代码</summary>
...
![注释轨道](/old/img/bio-plots/149-ss-track.png)
...
<details>
<summary>展开查看：注释段表与绘图代码</summary>
...
![口袋体积](/old/img/bio-plots/151-pocket-volume.png)
...
<details>
<summary>展开查看：口袋体积数据与绘图代码</summary>
...
![保守性剖面](/old/img/bio-plots/152-conservation.png)
...
<details>
<summary>展开查看：保守性数据（节选）与绘图代码</summary>
...
![对接图](/old/img/bio-plots/153-docking.png)
...
<details>
<summary>展开查看：位姿与化合物打分表及绘图代码</summary>
...
![界面接触](/old/img/bio-plots/154-interface-contacts.png)
...
<details>
<summary>展开查看：接触频率矩阵与绘图代码</summary>
...
<details>
<summary>展开查看：SASA 数据（节选）与计算代码</summary>
...
![qPCR 标准曲线](/old/img/bio-plots/156-qpcr-stdcurve.png)
...
<details>
<summary>展开查看：Cq 数据与绘图代码</summary>
...
![RT-PCR 凝胶](/old/img/bio-plots/157-rt-pcr-gel.png)
...
<details>
<summary>展开查看：灰度数据与绘图代码</summary>
...
![组织热图](/old/img/bio-plots/158-gene-tissue-heatmap.png)
...
<details>
<summary>展开查看：表达矩阵与绘图代码</summary>
...
![野生种栽培种](/old/img/bio-plots/159-wild-cultivar.png)
...
<details>
<summary>展开查看：基因型表达数据与绘图代码</summary>
...
![突变体箱线图](/old/img/bio-plots/160-mutant-box.png)
...
<details>
<summary>展开查看：重复数据摘要与绘图代码</summary>
...
![GxE 折线](/old/img/bio-plots/161-gxe-lines.png)
...
<details>
<summary>展开查看：G×E 数据与绘图代码</summary>
...
![灰度qPCR相关](/old/img/bio-plots/162-gray-vs-qpcr.png)
...
<details>
<summary>展开查看：两法配对数据与绘图代码</summary>
...
![表达表型](/old/img/bio-plots/163-expr-pheno.png)
...
<details>
<summary>展开查看：表达-表型数据与绘图代码</summary>
...
<details>
<summary>展开查看：二面角计算与绘图代码</summary>
...
<details>
<summary>展开查看：B 因子数据（节选）与绘图代码</summary>
...
<details>
<summary>展开查看：接触数数据与计算代码</summary>
...
![MD 轨迹](/old/img/bio-plots/167-md-trace.png)
...
<details>
<summary>展开查看：轨迹数据与绘图代码</summary>
...
![氢键占用](/old/img/bio-plots/168-hbond-occupancy.png)
...
<details>
<summary>展开查看：占用率数据与绘图代码</summary>
...
![二维互作图](/old/img/bio-plots/169-ligand-2d.png)
...
![共进化接触](/old/img/bio-plots/170-coevolution-contacts.png)
...
<details>
<summary>展开查看：打分数据与绘图代码</summary>
...
![熔解曲线](/old/img/bio-plots/171-melt-curve.png)
...
<details>
<summary>展开查看：熔解数据与绘图代码</summary>
...
![循环线性](/old/img/bio-plots/172-cycle-linearity.png)
...
<details>
<summary>展开查看：循环梯度数据与绘图代码</summary>
...
![Western blot](/old/img/bio-plots/173-western-blot.png)
...
六篇合计 **195 张图**：[第一篇](/2026/09/12/2026-09-12-01-bio-plots-01-axes-and-languages/) 41 张（统计、转录组、临床）、[第二篇](/2026/09/12/2026-09-12-02-bio-plots-02-population-single-cell/) 33 张（群体遗传、比较基因组、单细胞）、[第三篇](/2026/09/12/2026-09-12-03-bio-plots-03-qc-to-spatial-omics/) 29 张（测序 QC、表观、空间组学）、[第四篇](/2026/09/12/2026-09-12-04-bio-plots-04-ppi-to-multiomics/) 30 张（蛋白、生化、生态、AI 多组学）、本篇 40 张（蛋白结构、变异与表达验证）、[第六篇（22 张，真实公开数据实战）](/2026/09/12/2026-09-12-08-bio-plots-06-real-public-data/) 用 1001 Genomes 全基因组矩阵、AraPheno 表型、27genomes 表达/甲基化与 PDB 4LSX 换上真弹。本篇与前四篇最大的不同是**真实数据成建制进场**：16 张图基于四套公开坐标（6A15、1BI5/1I89、AlphaFold O64989、5ZD4），其中 4 张是浏览器里点按加载、直接拖拽的交互 3D——自托管 3Dmol 与 PDB 镜像，渲染不依赖任何第三方服务，页面打开时只摆加载按钮、不背 WebGL 负载；24 张模拟图补齐预测、对接与 qPCR/半定量验证的教学链路。老规矩不变：**图注里的每一个数字都与生成它的数据严格一致**，真实/模拟在每节「数据」行、图右下水印、速查表三处对账，折叠块里的 CSV 与代码让你从这篇网页直接复现到自己的终端——真实结构图的代码只吃一个 PDB 文件，把链接换成任何 RCSB 结构就能画你自己的蛋白。
...
| PDB 1I89（CHS G256L 突变体） | 140、145 | [RCSB 页面](https://www.rcsb.org/structure/1I89) · [文件下载](https://files.rcsb.org/download/1I89.pdb) | [`/lib/pdb/1i89.pdb`](/old/lib/pdb/1i89.pdb) |
| AlphaFold O64989（DWF4 预测模型，全局 pLDDT 89.75） | 141 | [AF DB 入口](https://alphafold.ebi.ac.uk/entry/O64989) · [模型文件](https://alphafold.ebi.ac.uk/files/AF-O64989-F1-model_v6.pdb) | [`/lib/pdb/af-o64989.pdb`](/old/lib/pdb/af-o64989.pdb) |
| PDB 5ZD4（BIL1/BZR1 DBD-DNA 复合物） | 142 | [RCSB 页面](https://www.rcsb.org/structure/5ZD4) · [文件下载](https://files.rcsb.org/download/5ZD4.pdb) | [`/lib/pdb/5zd4.pdb`](/old/lib/pdb/5zd4.pdb) |
...
> **原文存档**：本文初版发布于旧站（Butterfly 主题）。如遇图表、代码高亮或 3D 交互显示异常，请查阅 [完整存档版](/old/2026/09/12/2026-09-12-05-生信图表大全第五篇-蛋白结构变异与表达验证的40张图)。
