...
description: "系列的最后一块拼图。前三篇走完了统计、转录组、群体遗传、基因组、表观和空间组学，这一篇收剩下的三大块：分子的层面（蛋白结构域、分子互作、湿实验验证，104-114）、群落的层面（微生物生态、代谢组与宏基因组，115-…"
publishDate: 2026-09-12 11:00:00
...
![结构域架构](/old/img/bio-plots/104-domains.png)
...
<details>
<summary>展开查看：结构域坐标与绘图代码</summary>
...
![pLDDT 曲线](/old/img/bio-plots/105-plddt.png)
...
<details>
<summary>展开查看：pLDDT 数据与绘图代码</summary>
...
![RMSF 曲线](/old/img/bio-plots/106-rmsf.png)
...
<details>
<summary>展开查看：RMSF 数据与绘图代码</summary>
...
![自由能面](/old/img/bio-plots/107-fel.png)
...
<details>
<summary>展开查看：网格数据与绘图代码</summary>
...
![EMSA](/old/img/bio-plots/108-emsa.png)
...
![亚细胞定位](/old/img/bio-plots/109-subcell.png)
...
![双倒数图](/old/img/bio-plots/110-lineweaver.png)
...
<details>
<summary>展开查看：动力学数据与绘图代码</summary>
...
![DSF 曲线](/old/img/bio-plots/111-dsf.png)
...
<details>
<summary>展开查看：RFU 数据与绘图代码</summary>
...
![ELISA 曲线](/old/img/bio-plots/112-elisa.png)
...
<details>
<summary>展开查看：标准品数据与绘图代码</summary>
...
![荧光位移](/old/img/bio-plots/113-fluor-shift.png)
...
<details>
<summary>展开查看：光谱数据与绘图代码</summary>
...
![双荧光素酶](/old/img/bio-plots/114-luciferase.png)
...
![稀疏化曲线](/old/img/bio-plots/115-rarefaction.png)
...
<details>
<summary>展开查看：稀疏化数据与绘图代码</summary>
...
![rank-abundance 曲线](/old/img/bio-plots/116-rank-abund.png)
...
<details>
<summary>展开查看：秩-丰度数据与绘图代码</summary>
...
![三元相图](/old/img/bio-plots/117-ternary.png)
...
<details>
<summary>展开查看：组成数据与绘图代码</summary>
...
![RDA 排序图](/old/img/bio-plots/118-rda.png)
...
<details>
<summary>展开查看：样方与因子数据、绘图代码</summary>
...
![LEfSe 分支图](/old/img/bio-plots/119-lefse.png)
...
<details>
<summary>展开查看：分类层级数据与绘图代码</summary>
...
![时间杀菌曲线](/old/img/bio-plots/120-time-kill.png)
...
<details>
<summary>展开查看：计数数据与绘图代码</summary>
...
![镜像质谱图](/old/img/bio-plots/121-mirror.png)
...
<details>
<summary>展开查看：谱峰数据与绘图代码</summary>
...
![Van Krevelen 图](/old/img/bio-plots/122-vankrevelen.png)
...
<details>
<summary>展开查看：元素比数据与绘图代码</summary>
...
![Blob 图](/old/img/bio-plots/123-blob.png)
...
<details>
<summary>展开查看：bin 数据与绘图代码</summary>
...
![MOFA 因子图](/old/img/bio-plots/124-mofa.png)
...
<details>
<summary>展开查看：因子坐标与 R2 数据、绘图代码</summary>
...
![归因轨迹图](/old/img/bio-plots/125-saliency.png)
...
<details>
<summary>展开查看：归因数据与绘图代码</summary>
...
![蛋白嵌入 UMAP](/old/img/bio-plots/126-protein-embed.png)
...
<details>
<summary>展开查看：嵌入坐标与绘图代码</summary>
...
![泛基因组图](/old/img/bio-plots/127-pangenome.png)
...
<details>
<summary>展开查看：节点与边数据、绘图代码</summary>
...
![跨组学 UMAP](/old/img/bio-plots/128-multiomics.png)
...
![漏斗图](/old/img/bio-plots/129-funnel.png)
...
<details>
<summary>展开查看：研究数据与绘图代码</summary>
...
![哑铃图](/old/img/bio-plots/130-dumbbell.png)
...
<details>
<summary>展开查看：NES 数据与绘图代码</summary>
...
![瀑布图](/old/img/bio-plots/131-waterfall.png)
...
<details>
<summary>展开查看：响应数据与绘图代码</summary>
...
![帕累托图](/old/img/bio-plots/132-pareto.png)
...
<details>
<summary>展开查看：频次数据与绘图代码</summary>
...
![3D PCA](/old/img/bio-plots/133-pca3d.png)
...
- [Linxira Bio SDK](https://github.com/Linxira-OS/linxira-bio-sdk)：本地优先的生信执行工具链（[官网](https://linxira-os.github.io/bio-sdk/zh/)）；架构思路见我的[拆解文](/old//2026/08/19/2026-08-19-05-拆Bio-SDK-一个不生成脚本的本地生信工具链是怎么搭的/)。
- 系列前三篇：[第一篇](/2026/09/12/2026-09-12-01-bio-plots-01-axes-and-languages/) · [第二篇](/2026/09/12/2026-09-12-02-bio-plots-02-population-single-cell/) · [第三篇](/2026/09/12/2026-09-12-03-bio-plots-03-qc-to-spatial-omics/)。


---

> **原文存档**：本文初版发布于旧站（Butterfly 主题）。如遇图表、代码高亮或 3D 交互显示异常，请查阅 [完整存档版](/old/2026/09/12/2026-09-12-04-生信图表大全第四篇-从蛋白互作到AI多组学的30张图)。
