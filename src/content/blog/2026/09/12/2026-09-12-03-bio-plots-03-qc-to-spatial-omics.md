...
description: "第一篇收统计与转录组临床的 41 张，第二篇收群体遗传与基因组的 33 张。这一篇把镜头对准数据的入口和出口：测序数据拿到手先做什么质检（75-79），变异与群体层面有哪些图（80-86），GWAS 显著位点怎么往下…"
publishDate: 2026-09-12 10:00:00
tags: ["图表大全", "科研绘图", "生信入门", "重测序"]
---


[第一篇](/2026/09/12/2026-09-12-01-bio-plots-01-axes-and-languages/)收统计与转录组临床的 41 张，[第二篇](/2026/09/12/2026-09-12-02-bio-plots-02-population-single-cell/)收群体遗传与基因组的 33 张。这一篇把镜头对准数据的**入口和出口**：测序数据拿到手先做什么质检（75-79），变异与群体层面有哪些图（80-86），GWAS 显著位点怎么往下讲（87-88），育种和功能基因组怎么收尾（89-97），最后一章进到单细胞与空间组学（98-103）。编号接着第二篇，从 75 排到 103，共 **29 张**。
...
![逐循环质量](/old/img/bio-plots/75-fastq-qc.png)
...
<details>
<summary>展开查看：QC 数据与绘图代码</summary>
...
![GC 偏倚](/old/img/bio-plots/76-gc-bias.png)
...
![Sanger 峰图](/old/img/bio-plots/77-sanger.png)
...
<details>
<summary>展开查看：判读数据与绘图代码</summary>
...
![sashimi 图](/old/img/bio-plots/78-sashimi.png)
...
<details>
<summary>展开查看：外显子剪接数据与绘图代码</summary>
...
![pileup 图](/old/img/bio-plots/79-pileup.png)
...
<details>
<summary>展开查看：读段列表与绘图代码</summary>
...
![突变频谱](/old/img/bio-plots/80-mut-spectrum.png)
...
![SFS](/old/img/bio-plots/81-sfs.png)
...
![Tajima's D](/old/img/bio-plots/82-tajima.png)
...
<details>
<summary>展开查看：滑窗数据与绘图代码</summary>
...
![单倍型网络](/old/img/bio-plots/83-hap-network.png)
...
<details>
<summary>展开查看：节点边表与绘图代码</summary>
...
![GRM 热图](/old/img/bio-plots/84-grm.png)
...
<details>
<summary>展开查看：矩阵数据与绘图代码</summary>
...
![选择信号三联](/old/img/bio-plots/85-sweep-trio.png)
...
![群体结构双联](/old/img/bio-plots/86-structure.png)
...
![LocusZoom](/old/img/bio-plots/87-locuszoom.png)
...
<details>
<summary>展开查看：区域 SNP 数据与绘图代码</summary>
...
![PIP 图](/old/img/bio-plots/88-pip.png)
...
<details>
<summary>展开查看：PIP 数据与绘图代码</summary>
...
![QTL LOD](/old/img/bio-plots/89-qtl-lod.png)
...
<details>
<summary>展开查看：LOD 数据与绘图代码</summary>
...
![连锁图谱](/old/img/bio-plots/90-linkage-map.png)
...
<details>
<summary>展开查看：标记坐标与绘图代码</summary>
...
![AMMI 双标图](/old/img/bio-plots/91-ammi.png)
...
![GO DAG](/old/img/bio-plots/92-go-dag.png)
...
<details>
<summary>展开查看：节点数据与绘图代码</summary>
...
![ChIP 剖面热图](/old/img/bio-plots/93-chip.png)
...
<details>
<summary>展开查看：剖面数据与绘图代码</summary>
...
![足迹图](/old/img/bio-plots/94-footprint.png)
...
<details>
<summary>展开查看：切割数据与绘图代码</summary>
...
![WGCNA 全装](/old/img/bio-plots/95-wgcna-tree.png)
...
<details>
<summary>展开查看：模块归属与绘图代码</summary>
...
![甲基化三语境](/old/img/bio-plots/96-methylation.png)
...
![Hi-C 热图](/old/img/bio-plots/97-hic.png)
...
<details>
<summary>展开查看：TAD 区间与绘图代码</summary>
...
![velocity 相图](/old/img/bio-plots/98-velocity.png)
...
![组成堆叠](/old/img/bio-plots/99-composition.png)
...
![marker 热图](/old/img/bio-plots/100-markers.png)
...
![通讯圈图](/old/img/bio-plots/101-ccc-circle.png)
...
![LR 气泡图](/old/img/bio-plots/102-lr-bubble.png)
...
<details>
<summary>展开查看：气泡数据与绘图代码</summary>
...
![空间 spot 图](/old/img/bio-plots/103-spatial.png)
...
> **原文存档**：本文初版发布于旧站（Butterfly 主题）。如遇图表、代码高亮或 3D 交互显示异常，请查阅 [完整存档版](/old/2026/09/12/2026-09-12-03-生信图表大全第三篇-从测序QC到空间组学的29张图)。
