...
description: "第一篇收了 41 张图，评论区（其实就是我自己复盘）发现问题：不是每张图都带了绘图代码。这一篇补上，并且把版图扩到上一篇没碰的领域——群体遗传与 GWAS、比较基因组、基因家族、微生物组、单细胞轨迹、WGCNA、生化…"
publishDate: 2026-09-12 09:00:00
tags: ["图表大全", "科研绘图", "生信入门", "重测序"]
---


[第一篇收了 41 张图](/2026/09/12/2026-09-12-01-bio-plots-01-axes-and-languages/)，评论区（其实就是我自己复盘）发现问题：不是每张图都带了绘图代码。这一篇补上，并且把版图扩到上一篇没碰的领域——群体遗传与 GWAS、比较基因组、基因家族、微生物组、单细胞轨迹、WGCNA、生化曲线、机器学习、品种试验和蛋白结构模拟，共 **33 张新图**，编号接着第一篇从 42 排到 74。测序 QC、GWAS 精细定位、Hi-C 与空间组学放在[第三篇](/2026/09/12/2026-09-12-03-bio-plots-03-qc-to-spatial-omics/)，蛋白、生态与 AI 多组学放在[第四篇](/2026/09/12/2026-09-12-04-bio-plots-04-ppi-to-multiomics/)。
...
![曼哈顿图](/old/img/bio-plots/42-manhattan.png)

**它回答什么问题**：全基因组几十万个位点里，哪几个与性状显著关联——GWAS 的招牌图，也是[群体重测序](/2026/09/10/2026-09-10-01-population-resequencing-fastq-to-selection/)流程的终点站。
...
<details>
<summary>展开查看：显著位点数据与完整绘图代码</summary>
...
![QQ 图](/old/img/bio-plots/43-qq.png)
...
<details>
<summary>展开查看：完整绘图代码（含数据生成）</summary>
...
![LD 衰减图](/old/img/bio-plots/44-lddecay.png)
...
<details>
<summary>展开查看：分箱数据与完整绘图代码</summary>
...
![ADMIXTURE 图](/old/img/bio-plots/45-admixture.png)
...
![系统发育树](/old/img/bio-plots/46-phylo.png)
...
<details>
<summary>展开查看：坐标数据与绘图代码</summary>
...
![滑窗 pi 与 Fst](/old/img/bio-plots/47-pi-fst.png)
...
![共线性点阵](/old/img/bio-plots/48-dotplot.png)
...
![Ka/Ks 分布](/old/img/bio-plots/49-kaks.png)
...
<details>
<summary>展开查看：分箱数据与绘图代码</summary>
...
![染色体定位图](/old/img/bio-plots/50-chrloc.png)
...
![Circos 圈图](/old/img/bio-plots/51-circos.png)
...
<details>
<summary>展开查看：区块坐标与绘图代码</summary>
...
![基因密度](/old/img/bio-plots/52-genedensity.png)
...
![Motif logo](/old/img/bio-plots/53-motiflogo.png)
...
<details>
<summary>展开查看：PWM 数据与绘图代码</summary>
...
![基因结构图](/old/img/bio-plots/54-genestructure.png)
...
<details>
<summary>展开查看：结构坐标与绘图代码</summary>
...
![MSA 保守性](/old/img/bio-plots/55-msa.png)
...
<details>
<summary>展开查看：逐位数据与绘图代码</summary>
...
![PCoA](/old/img/bio-plots/56-pcoa.png)
...
![Alpha 多样性](/old/img/bio-plots/57-alpha.png)
...
![丰度堆叠图](/old/img/bio-plots/58-abundance.png)
...
![拟时序轨迹](/old/img/bio-plots/59-trajectory.png)
...
![单细胞点图](/old/img/bio-plots/60-scdotplot.png)
...
![PPI 网络](/old/img/bio-plots/61-ppi.png)
...
![模块性状热图](/old/img/bio-plots/62-moduletrait.png)
...
<details>
<summary>展开查看：相关矩阵与绘图代码</summary>
...
![剂量响应曲线](/old/img/bio-plots/63-dose.png)
...
<details>
<summary>展开查看：剂量数据与绘图代码</summary>
...
![米氏动力学](/old/img/bio-plots/64-michaelis.png)
...
![凝胶电泳](/old/img/bio-plots/65-gel.png)
...
<details>
<summary>展开查看：绘图代码（示意条带）</summary>
...
![生长曲线](/old/img/bio-plots/66-growth.png)
...
![PR 曲线](/old/img/bio-plots/67-pr.png)
...
![混淆矩阵](/old/img/bio-plots/68-confusion.png)
...
![碎石图](/old/img/bio-plots/69-scree.png)
...
![特征重要性](/old/img/bio-plots/70-featimp.png)
...
![雷达图](/old/img/bio-plots/71-radar.png)
...
![GGE 双标图](/old/img/bio-plots/72-gge.png)
...
<details>
<summary>展开查看：产量矩阵与绘图代码</summary>
...
![拉氏图](/old/img/bio-plots/73-ramachandran.png)
...
![RMSD 曲线](/old/img/bio-plots/74-rmsd.png)
...
本篇全部图与数据的生成脚本在仓库 `tools/bio-plots/ch9a_more.py`、`ch9b_more.py`、`ch9c_more.py`，模拟数据的随机种子固定，跑出来的图与文中的每一根线条一致。系列没有断在这里：[第三篇](/2026/09/12/2026-09-12-03-bio-plots-03-qc-to-spatial-omics/)接着收测序 QC、GWAS 精细定位、Hi-C 与空间组学，[第四篇](/2026/09/12/2026-09-12-04-bio-plots-04-ppi-to-multiomics/)收蛋白、生态与 AI 多组学的新图，四篇合计 133 张。
...
> **原文存档**：本文初版发布于旧站（Butterfly 主题）。如遇图表、代码高亮或 3D 交互显示异常，请查阅 [完整存档版](/old/2026/09/12/2026-09-12-02-生信图表大全第二篇-群体遗传比较基因组与单细胞的33张图)。
