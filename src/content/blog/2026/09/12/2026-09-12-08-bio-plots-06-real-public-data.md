...
description: "本系列已出七篇：第一篇（41 张，统计与转录组临床） · 第二篇（33 张，群体遗传与基因组） · 第三篇（29 张，测序、表观与空间组学） · 第四篇（30 张，蛋白、生态与 AI 多组学） · 第五篇（40 张，…"
publishDate: 2026-09-12 15:00:00
tags: ["图表大全", "群体遗传", "GWAS", "表观遗传", "结构生物学"]
---


本系列已出七篇：[第一篇（41 张，统计与转录组临床）](/2026/09/12/2026-09-12-01-bio-plots-01-axes-and-languages/) · [第二篇（33 张，群体遗传与基因组）](/2026/09/12/2026-09-12-02-bio-plots-02-population-single-cell/) · [第三篇（29 张，测序、表观与空间组学）](/2026/09/12/2026-09-12-03-bio-plots-03-qc-to-spatial-omics/) · [第四篇（30 张，蛋白、生态与 AI 多组学）](/2026/09/12/2026-09-12-04-bio-plots-04-ppi-to-multiomics/) · [第五篇（40 张，蛋白结构、变异与表达验证）](/2026/09/12/2026-09-12-05-bio-plots-05-protein-structure-validation/) · 第六篇（22 张，真实公开数据实战）即本篇 · [第七篇（190 张图 Nature 风格重构与方法选型）](/2026/09/13/2026-09-13-01-bio-plots-07-nature-style-restyle/)。
...
<details>
<summary>展开查看：本章公共代码——HDF5 分块扫描与基因型读取</summary>
...
![图 174 基因型 PCA](/old/img/bio-plots/174_real_pca.png)
...
![图 175 LD 衰减](/old/img/bio-plots/175_real_ld_decay.png)
...
<details>
<summary>展开查看：LD 衰减绘图代码</summary>
...
![图 176 Fst 滑窗](/old/img/bio-plots/176_real_fst_chr1.png)
...
<details>
<summary>展开查看：Fst 滑窗绘图代码</summary>
...
![图 177 折叠位点频率谱](/old/img/bio-plots/177_real_sfs.png)
...
![图 178 SNP 密度](/old/img/bio-plots/178_real_snp_density.png)
...
<details>
<summary>展开查看：SNP 密度绘图代码</summary>
...
![图 179 根长 vs 采集纬度](/old/img/bio-plots/179_real_pheno_by_country.png)
...
![图 180 根长 GWAS Manhattan 图](/old/img/bio-plots/180_real_manhattan.png)
...
<details>
<summary>展开查看：GWAS 扫描与 Manhattan 绘图代码</summary>
...
![图 181 QQ 图](/old/img/bio-plots/181_real_qq.png)
...
![图 182 区域关联图](/old/img/bio-plots/182_real_region.png)
...
![图 183 组织表达热图](/old/img/bio-plots/183_real_tissue_heatmap.png)
...
<details>
<summary>展开查看：bigWig 远程查询与热图代码</summary>
...
![图 184 accession 表达 PCA](/old/img/bio-plots/184_real_expression_pca.png)
...
<details>
<summary>展开查看：表达 PCA 绘图代码</summary>
...
![图 185 FLC 座位覆盖度 track](/old/img/bio-plots/185_real_flc_coverage.png)
...
<details>
<summary>展开查看：覆盖度 track 绘图代码</summary>
...
![图 186 基因模型统计](/old/img/bio-plots/186_real_gene_models.png)
...
<details>
<summary>展开查看：GFF 解析与统计代码</summary>
...
![图 187 采集地理分布](/old/img/bio-plots/187_real_geo_scatter.png)
...
![图 189 BRI1-SERK1 界面接触图](/old/img/bio-plots/189_real_4lsx_contactmap.png)
...
![图 190 逐残基 B 因子](/old/img/bio-plots/190_real_4lsx_bfactor.png)
...
![图 191 界面残基埋藏面积](/old/img/bio-plots/191_real_4lsx_dasa.png)
...
<details>
<summary>展开查看：ΔSASA 绘图代码</summary>
...
![图 192 基因型 PCA 对照](/old/img/bio-plots/192_sim_vs_real_pca.png)
...
<details>
<summary>展开查看：对照 PCA 绘图代码</summary>
...
![图 193 表达热图对照](/old/img/bio-plots/193_sim_vs_real_heatmap.png)
...
![图 194 LD 衰减对照](/old/img/bio-plots/194_sim_vs_real_ld.png)
...
<details>
<summary>展开查看：对照 LD 绘图代码</summary>
...
![图 195 QQ 图对照](/old/img/bio-plots/195_sim_vs_real_qq.png)
...
<details>
<summary>展开查看：对照 QQ 绘图代码</summary>
...
六篇合计 **195 张图**：[第一篇](/2026/09/12/2026-09-12-01-bio-plots-01-axes-and-languages/) 41 张打底、[第二篇](/2026/09/12/2026-09-12-02-bio-plots-02-population-single-cell/) 33 张进阶、[第三篇](/2026/09/12/2026-09-12-03-bio-plots-03-qc-to-spatial-omics/) 29 张承接、[第四篇](/2026/09/12/2026-09-12-04-bio-plots-04-ppi-to-multiomics/) 30 张收拢、[第五篇](/2026/09/12/2026-09-12-05-bio-plots-05-protein-structure-validation/) 40 张上强度，本篇 22 张换真弹。模拟教会画法，真实教会敬畏：官方 release 的 36 个甲基化 bigWig 整包是空壳、DDM1 不在注释集里、AP1 的信号躲在 R 链文件里、RD29A 爆表是生长条件不是组织特异性、100 份样本的 GWAS 最高信号就是够不着 Bonferroni 线——**这些坑不在任何图型教程里，只有真数据会教你**。图注里的每一个数字都与生成它的数据严格一致，折叠块里的代码 + 数据来源表（第一章）让你从这张网页一路复现到自己的终端——在 WSL 里，或者任何一台原生 Linux 上。**第七篇已出：[190 张图重画成 Nature 风格](/2026/09/13/2026-09-13-01-bio-plots-07-nature-style-restyle/)；第八篇在路上。**
...
> **原文存档**：本文初版发布于旧站（Butterfly 主题）。如遇图表、代码高亮或 3D 交互显示异常，请查阅 [完整存档版](/old/2026/09/12/2026-09-12-08-生信图表大全第六篇-用真实公开数据画的22张图)。
