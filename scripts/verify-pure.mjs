...
const checks = {
  '第六篇文章页': 'dist/2026/09/12/2026-09-12-08-bio-plots-06-real-public-data/index.html',
  '第五篇(3D)': 'dist/2026/09/12/2026-09-12-05-bio-plots-05-protein-structure-validation/index.html',
  '改名跳转页样本': 'dist/2026/09/12/2026-09-12-08-生信图表大全第六篇-用真实公开数据画的22张图/index.html',
